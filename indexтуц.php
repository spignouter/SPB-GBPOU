...
if (isset($_POST['username']) and isset($_POST['password'])){
	...
	// Подключение библиотеки работающий с актив директори. 
...
// Если в куках и в переменной сессии не было установлено имя пользователя, 
...
// Если имя установлено в куках то выполняем это
else{
